...
'''
I designed it
Searchs for multiple images on the screen without taking multiple screenshots
...
returns :
path to the image found, or empty string if none found
...
'''
I designed it
Searchs for multiple images on a screen area without taking multiple screenshots
...
returns :
coord of the image found, or [-1, -1] if none found
